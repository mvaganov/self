...
* **how to understand unintuitive ideas** - that software works in ways that are not always easy to understand, but are still true, and eventually understandable. Comfort with specifically *unintuitive* ideas acts as a defense against a variety of cognative biases, like stereotyping, and the-band-wagon effect.
