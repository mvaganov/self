...
* **faith in science** - that hypothesis testing is an effective tool for developing human knowledge. This is such a regular part of computer-science that it is easy to miss. Eery time a teacher asks "What does this code do?" or a student says "I think this will work", there is hypothesis testing going on.
* **metacognitive awareness** - that ability to think is determined by mental state, and *managing mental state* (with food, sleep, addressing emotional issues, ...) is a foundation for successful problem solving. Programming does not make this obvious, but being aware of the tangible-results-of-programming, done in various mental states, does.
