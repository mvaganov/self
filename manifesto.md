...
### How will these systems show prove these tasks have our best interests in mmind?

**"Impetus Project"** - There are some project management tools out there in the direction of Impetus Project. Project management tools really are getting good at visualizing the achievement of goals. New AI tools will be able to add narrativse, good estimates identify positive growth, and compelling game-like visulaizations & interfaces, like you might find in a Real Time Strategy game. Compelling-visualizations and auditable advancement will probably encourage engagement in the people monitoring projects with this tool, which we know games do. Consistent organic engagement seems to be the peice that is missing from modern ERP tools, and I suspect game development techniques will improve engagement and motivation, and AI will be able to multiply the attention of people managing the system.
